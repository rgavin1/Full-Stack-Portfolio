  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    color: 'white'
      ...
      <NavDropdown title="Projects" id="collasible-nav-dropdown">
        ...
        <NavDropdown.Item title="Movie Search Application" className="text-muted">
          <Link to="/MovieSearch">Movie Search Application</Link>
        </NavDropdown.Item>
    ...
    <Nav>
      ...
      <Nav.Link title="Resume" href="https://docs.google.com/document/d/1SZa2Q3PXxO-WePSAFtz4FuXdK9tlGGaQDLaxt-hgzzA/edit?usp=sharing" target="blank" style={{
        fontSize: '1.7em',
        color: 'white'
      }}>
